...
- `revise` : the proposal has fixable issues in the copy or in the choice of
  alternative_targets within the catalog; list them clearly
...
Full catalog the writer chose from (URL: title). Use this to validate
`alternative_targets` and decide whether a better page exists:
