...
A succinct log of the steps taken on this take-home (for part 1)

1. Created a new repo and dropped in the project PDF and the data spreadsheet exported from Google Sheets.
...
12. Reviewed the plan and had agents review the plan.
13. Built the system end-to-end.
14. Wrote the ≤1-page README defending the chosen agent shape.
15. Ran it against a real LLM and saved the sample output.
16. Once finished, had fresh agents review the implementation and make refinements.
17. Tested myself (viewed output).
18. Re-read the instructions and self-checked the build against the rubric.
19. Had agents clean up unnecessary code, folders, files, etc.
20. Simplify document layout for human facing reviewers
